...
mod tests {
    ...
    fn test_apply_dipole_force_and_gradient_system() {
        ...
        let atom1 = test
            ...
            .insert(LaserIntensityGradientSamplers {
                contents: [LaserIntensityGradientSampler::default(); DEFAULT_BEAM_LIMIT],
            })
            .insert(transition)
            .id();
        ...
        test.add_systems(
            Update,
            sample_gaussian_laser_intensity_gradient::<
                { DEFAULT_BEAM_LIMIT },
        ...
        test.add_systems(
            Update,
            apply_dipole_force_system::<{ DEFAULT_BEAM_LIMIT }>.after(
                sample_gaussian_laser_intensity_gradient::<
                    { DEFAULT_BEAM_LIMIT },
                    RequiresIntensityGradientCalculation,
                >,
